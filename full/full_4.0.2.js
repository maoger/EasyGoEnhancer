...
function select_all_btn(){
    ...
    var btn_download = $("<button/>")
        ...
        .html("<span style='font-family:Calibri; font-size: 14px; font-weight: bold; color: #3f9c35'><i class='fas fa-check'></i>&nbsp;全选「是」</span>");
...
function select_all_yes(){
    var inputs = document.querySelectorAll('[value="是"]');
